...
Public Class rptPagoCompraPendiente
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPagoCompraPendiente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptPagoCompraPendiente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Monto_letra() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Valor() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPagoCompraPendiente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagoCompraPendiente = New rptPagoCompraPendiente()
        rpt.Site = Me.Site
        Return rpt
    End Function
