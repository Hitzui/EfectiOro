...
Public Class rptComprasAgrupado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptComprasAgrupado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComprasAgrupado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprasAgrupado = New rptComprasAgrupado()
        rpt.Site = Me.Site
        Return rpt
    End Function
