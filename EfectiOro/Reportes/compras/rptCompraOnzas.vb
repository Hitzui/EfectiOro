...
Public Class rptCompraOnzas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptCompraOnzas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompraOnzas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompraOnzas = New rptCompraOnzas()
        rpt.Site = Me.Site
        Return rpt
    End Function
