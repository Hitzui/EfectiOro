...
Public Class rptDetalleCompraTC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptDetalleCompraTC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalleCompraTC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleCompraTC = New rptDetalleCompraTC()
        rpt.Site = Me.Site
        Return rpt
    End Function
