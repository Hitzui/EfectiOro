...
Public Class rptHistoricoCierre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptHistoricoCierre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistoricoCierre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistoricoCierre = New rptHistoricoCierre()
        rpt.Site = Me.Site
        Return rpt
    End Function
