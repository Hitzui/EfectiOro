...
Public Class rptDescarguedet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptDescarguedet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDescarguedet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDescarguedet = New rptDescarguedet()
        rpt.Site = Me.Site
        Return rpt
    End Function
