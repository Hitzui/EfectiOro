...
Public Class rptDescargaGen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptDescargaGen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDescargaGen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDescargaGen = New rptDescargaGen()
        rpt.Site = Me.Site
        Return rpt
    End Function
