...
Public Class rptCatalogoPica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptCatalogoPica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatalogoPica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatalogoPica = New rptCatalogoPica()
        rpt.Site = Me.Site
        Return rpt
    End Function
