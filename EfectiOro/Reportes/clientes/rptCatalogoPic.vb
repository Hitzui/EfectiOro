...
Public Class rptCatalogoPic
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptCatalogoPic.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatalogoPic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatalogoPic = New rptCatalogoPic()
        rpt.Site = Me.Site
        Return rpt
    End Function
