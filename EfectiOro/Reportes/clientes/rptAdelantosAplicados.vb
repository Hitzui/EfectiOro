...
Public Class rptAdelantosAplicados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAdelantosAplicados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptAdelantosAplicados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdelantosAplicados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdelantosAplicados = New rptAdelantosAplicados()
        rpt.Site = Me.Site
        Return rpt
    End Function
