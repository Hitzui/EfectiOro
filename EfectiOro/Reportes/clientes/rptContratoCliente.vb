...
Public Class rptContratoCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptContratoCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContratoCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContratoCliente = New rptContratoCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
