...
Public Class rptEstadistico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptEstadistico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstadistico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstadistico = New rptEstadistico()
        rpt.Site = Me.Site
        Return rpt
    End Function
