...
Partial Class frmReporteCajaActual
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReporteCajaActual))
        Me.viewer = New CrystalDecisions.Windows.Forms.CrystalReportViewer()
        Me.rptCajaActual1 = New EfectiOro.rptCajaActual()
        Me.SuspendLayout()
        '
        'viewer
        '
    ...
    Friend WithEvents rptCajaActual1 As rptCajaActual
End Class
