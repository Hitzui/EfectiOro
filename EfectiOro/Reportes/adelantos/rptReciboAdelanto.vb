...
Public Class rptReciboAdelanto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EfectiOro.rptReciboAdelanto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboAdelanto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboAdelanto = New rptReciboAdelanto()
        rpt.Site = Me.Site
        Return rpt
    End Function
