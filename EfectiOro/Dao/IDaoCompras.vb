...
Public Interface IDaoCompras
    ...
    ''' <remarks></remarks>
    Function crearCompra(compra As Compras, detaCompras As List(Of Det_compra), Optional ByVal modcaja As Mcaja = Nothing,
                         Optional ByVal dcaja As Detacaja = Nothing, Optional ByVal listaAdelantos As List(Of Adelantos) = Nothing,
                         Optional ByVal listaPreciosaCerrar As List(Of CierrePrecios) = Nothing) As Boolean
    Function actualizarCompraDescargue(compra As Compras, agencia As String) As Boolean
    ...
    Function findCompraById(numerocompra As String, agencia As String) As Compras
