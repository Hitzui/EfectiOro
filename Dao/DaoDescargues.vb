...
Public Class DaoDescargues
    ...
    Public Function guardarLotoeDetaCompra(ByVal detalle As List(Of KeyValuePair(Of String, Integer)), descargue As Descargues) As Boolean Implements IDaoDescargues.guardarLotoeDetaCompra
        ...
        End Using
    End Function
    Public Function generarLote(fecha As Date) As System.Collections.Generic.List(Of Database.Compras) Implements IDaoDescargues.generarLote
        Using ctx As New Contexto
            Try
                ...
                '2 - Cerrado
                '3 - Descargado
                Dim generar = (From c In ctx.Compras
