...
#End Region
        ...
        Public Function AnularCompra(<Parameter(DbType:="VarChar(20)")> ByVal numeroCompra As String) As <Parameter(DbType:="Int")> Integer
            Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod, MethodInfo), numeroCompra)
...
#End Region
    ...
    Partial Public Class DetaReserva
        ...
        Private _entregadas As System.Nullable(Of Decimal)
...
#End Region
        ...
        Public Property entregadas() As System.Nullable(Of Decimal)
            Get
